...
![npm](https://img.shields.io/npm/v/ai-diff-summary)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-diff-summary)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Intelligent diff summarization and code change analysis tool

Intelligent diff analyzer. Creates meaningful change summaries for commits and pull requests.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-diff-summary.svg)](https://badge.fury.io/js/ai-diff-summary)
